...
!!! note
    ...
    Your pushes will fail if you have changed the models but have not generated migrations. There is a GitHub Action
    check in [migration.yaml](https://github.com/agency-fund/evidential-be/blob/main/.github/workflows/migration.yaml)
    to ensure that PRs include migrations that match the models.
...
!!! note
    ...
    Do not edit the migration files generated by Atlas. If you need a custom migration, see below.
...
## How do I rollback a migration that has been pushed to the production database?
