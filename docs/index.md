...
A free, open-source experiment engine built by and for nonprofits—putting rigorous, rapid learning in every organisation’s hands.
...
Evidential is not a product analytics tool, and it’s not built for full-scale Randomized Control Trials.

If you operate a single web or mobile app and want deep behavioural analytics, tools like Mixpanel or Amplitude are a better fit. These platforms assume a product and engineering team, and a substantial annual budget.

Likewise, if you're planning a one-off RCT with full counterfactuals and enumerator-managed arms, you’ll need a different setup.

Evidential shines when you want to continuously improve your complex program against its current version—10X faster than an RCT, but preserving its rigour.
...
- [Read the quick-start guide](welcome/getting-started.md)
